...
declare const colorPickerLight: import("naive-ui/es/_mixins/use-theme").Theme<"ColorPicker", {
    panelFontSize: string;
    boxShadow: string;
    color: string;
    textColor: string;
    ...
    Input: import("naive-ui/es/_mixins/use-theme").Theme<"Input", {
    ...
    Button: import("naive-ui/es/_mixins/use-theme").Theme<"Button", {
        heightTiny: string;
        heightSmall: string;
        heightMedium: string;
        heightLarge: string;
