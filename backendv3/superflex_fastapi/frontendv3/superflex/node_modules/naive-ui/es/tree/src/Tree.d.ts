...
import type { TreeDragInfo, TreeDropInfo, TreeOptions, Key, TreeOption, AllowDrop, RenderSwitcherIcon, TreeNodeProps, CheckOnClick, GetChildren, OnLoad, TreeOverrideNodeClickBehavior } from 'naive-ui/es/tree/src/interface';
import { defaultAllowDrop } from 'naive-ui/es/tree/src/dnd';
import { type ScrollbarProps } from 'naive-ui/es/scrollbar/src/Scrollbar';
...
declare const _default: import("vue").DefineComponent<{
    ...
    handleKeydown: (e: KeyboardEvent) => {
        enterBehavior: import("naive-ui/es/tree/src/interface").TreeOverrideNodeClickBehaviorReturn | null;
    };
    scrollTo: import("vueuc").VirtualListScrollTo;
    getCheckedData: () => {
        keys: Key[];
