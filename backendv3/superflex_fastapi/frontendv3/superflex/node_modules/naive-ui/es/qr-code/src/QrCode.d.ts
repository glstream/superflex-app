...
export declare const qrCodeProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"QrCode", {
        borderRadius: string;
    }, any>>;
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"QrCode", {
        borderRadius: string;
    }, any>>>;
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"QrCode", {
        borderRadius: string;
    }, any>>>;
};
