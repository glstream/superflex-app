...
export declare const flexProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Flex", {
        gapSmall: string;
        gapMedium: string;
        gapLarge: string;
    }, any>>;
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Flex", {
        gapSmall: string;
        gapMedium: string;
        gapLarge: string;
    }, any>>>;
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Flex", {
        gapSmall: string;
        gapMedium: string;
        gapLarge: string;
    }, any>>>;
