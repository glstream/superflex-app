import type { PickerBaseProps as RCPickerBaseProps, PickerDateProps as RCPickerDateProps, PickerTimeProps as RCPickerTimeProps } from 'ant-design-vue/es/vc-picker/Picker';
import type { RangePickerBaseProps as RCRangePickerBaseProps, RangePickerDateProps as RCRangePickerDateProps, RangePickerTimeProps as RCRangePickerTimeProps } from 'ant-design-vue/es/vc-picker/RangePicker';
import type { Locale as RcPickerLocale } from 'ant-design-vue/es/vc-picker/interface';
import type { TimePickerLocale } from 'ant-design-vue/es/time-picker';
