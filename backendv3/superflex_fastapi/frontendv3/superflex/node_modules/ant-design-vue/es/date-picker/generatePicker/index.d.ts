import type { GenerateConfig } from 'ant-design-vue/es/vc-picker/generate';
...
import PickerTag from 'ant-design-vue/es/date-picker/PickerTag';
export * from 'ant-design-vue/es/date-picker/generatePicker/interface';
...
declare function generatePicker<DateType, ExtraProps extends {} = {}>(generateConfig: GenerateConfig<DateType>, extraProps?: ExtraProps): {
    DatePicker: import("vue").DefineComponent<{
        ...
        presets: {
            type: import("vue").PropType<import("ant-design-vue/es/vc-picker/interface").PresetDate<DateType>[]>;
            default: import("ant-design-vue/es/vc-picker/interface").PresetDate<DateType>[];
        };
        disabledTime: {
            type: import("vue").PropType<import("ant-design-vue/es/vc-picker/interface").DisabledTime<DateType>>;
            default: import("ant-design-vue/es/vc-picker/interface").DisabledTime<DateType>;
        };
        renderExtraFooter: {
        ...
        monthCellRender: {
            type: import("vue").PropType<import("ant-design-vue/es/vc-picker/panels/MonthPanel/MonthBody").MonthCellRender<DateType>>;
            default: import("ant-design-vue/es/vc-picker/panels/MonthPanel/MonthBody").MonthCellRender<DateType>;
        };
        ...
        format: {
            type: import("vue").PropType<string | import("ant-design-vue/es/vc-picker/interface").CustomFormat<DateType> | (string | import("ant-design-vue/es/vc-picker/interface").CustomFormat<DateType>)[]>;
            default: string | import("ant-design-vue/es/vc-picker/interface").CustomFormat<DateType> | (string | import("ant-design-vue/es/vc-picker/interface").CustomFormat<DateType>)[];
        };
        getPopupContainer: {
        ...
        locale: {
            type: import("vue").PropType<import("ant-design-vue/es/date-picker/generatePicker/interface").PickerLocale>;
            default: import("ant-design-vue/es/date-picker/generatePicker/interface").PickerLocale;
        };
        size: {
            type: import("vue").PropType<import("ant-design-vue/es/config-provider").SizeType>;
        ...
        dateRender: {
            type: import("vue").PropType<import("ant-design-vue/es/vc-picker/panels/DatePanel/DateBody").DateRender<DateType>>;
            default: import("ant-design-vue/es/vc-picker/panels/DatePanel/DateBody").DateRender<DateType>;
        };
        disabledDate: {
    ...
    } & ExtraProps, () => import("ant-design-vue/es/_util/type").VueNode, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {}, string, import("vue").PublicProps, Readonly<{
        defaultPickerValue: {
            type: import("vue").PropType<string | DateType>;
            default: string | DateType;
        };
    ...
    } & ExtraProps>, import("ant-design-vue/es/_util/type").CustomSlotsType<{
        suffixIcon?: any;
        prevIcon?: any;
        nextIcon?: any;
        superPrevIcon?: any;
    ...
    RangePicker: import("vue").DefineComponent<{
        ...
        dateRender: {
            type: import("vue").PropType<import("ant-design-vue/es/vc-picker/RangePicker").RangeDateRender<DateType>>;
            default: import("ant-design-vue/es/vc-picker/RangePicker").RangeDateRender<DateType>;
        };
        defaultPickerValue: {
        ...
        disabledTime: {
            type: import("vue").PropType<(date: DateType, type: import("ant-design-vue/es/vc-picker/RangePicker").RangeType) => import("ant-design-vue/es/vc-picker/interface").DisabledTimes>;
            default: (date: DateType, type: import("ant-design-vue/es/vc-picker/RangePicker").RangeType) => import("ant-design-vue/es/vc-picker/interface").DisabledTimes;
        };
        disabled: {
        ...
        onCalendarChange: {
            type: import("vue").PropType<(values: [string, string] | [DateType, DateType], formatString: [string, string], info: import("ant-design-vue/es/vc-picker/RangePicker").RangeInfo) => void>;
            default: (values: [string, string] | [DateType, DateType], formatString: [string, string], info: import("ant-design-vue/es/vc-picker/RangePicker").RangeInfo) => void;
        };
        onPanelChange: {
            type: import("vue").PropType<(values: [string, string] | [DateType, DateType], modes: [import("ant-design-vue/es/vc-picker/interface").PanelMode, import("ant-design-vue/es/vc-picker/interface").PanelMode]) => void>;
            default: (values: [string, string] | [DateType, DateType], modes: [import("ant-design-vue/es/vc-picker/interface").PanelMode, import("ant-design-vue/es/vc-picker/interface").PanelMode]) => void;
        };
        onOk: {
