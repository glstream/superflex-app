...
import type { CustomSlotsType, Key } from 'ant-design-vue/es/_util/type';
import ItemMeta from 'ant-design-vue/es/list/ItemMeta';
export type { ListItemProps } from 'ant-design-vue/es/list/Item';
export type { ListItemMetaProps } from 'ant-design-vue/es/list/ItemMeta';
...
export declare const listProps: () => {
    ...
    pagination: {
        type: PropType<false | Partial<ExtractPropTypes<{
            position: {
                type: PropType<import("ant-design-vue/es/pagination/Pagination").PaginationPosition>;
                default: import("ant-design-vue/es/pagination/Pagination").PaginationPosition;
            };
