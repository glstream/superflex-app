import type { CSSInterpolation, Theme } from 'ant-design-vue/es/_util/cssinjs';
import { useStyleRegister } from 'ant-design-vue/es/_util/cssinjs';
import type { AliasToken, GlobalToken, MapToken, OverrideToken, PresetColorType, PresetColorKey, SeedToken } from 'ant-design-vue/es/theme/interface';
import { PresetColors } from 'ant-design-vue/es/theme/interface';
import type { FullToken } from 'ant-design-vue/es/theme/util/genComponentStyleHook';
import genComponentStyleHook from 'ant-design-vue/es/theme/util/genComponentStyleHook';
import statisticToken, { merge as mergeToken, statistic } from 'ant-design-vue/es/theme/util/statistic';
