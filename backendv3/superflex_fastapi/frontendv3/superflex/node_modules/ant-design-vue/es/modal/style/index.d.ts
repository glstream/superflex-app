import type { AliasToken, FullToken, GenerateStyle } from 'ant-design-vue/es/theme/internal';
import type { TokenWithCommonCls } from 'ant-design-vue/es/theme/util/genComponentStyleHook';
...
declare const _default: (_prefixCls?: import("vue").Ref<string>) => import("ant-design-vue/es/theme/internal").UseComponentStyleResult;
