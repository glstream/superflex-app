import type { ShowSearchType, FieldNames, BaseOptionType, DefaultOptionType } from 'ant-design-vue/es/vc-cascader';
import { SHOW_CHILD, SHOW_PARENT } from 'ant-design-vue/es/vc-cascader';
...
export declare function cascaderProps<DataNodeType extends CascaderOptionType = CascaderOptionType>(): {
    ...
    popupPlacement: PropType<import("ant-design-vue/es/vc-select/BaseSelect").Placement>;
    popupVisible: {
        type: BooleanConstructor;
        default: any;
    };
    ...
    showCheckedStrategy: {
        type: PropType<import("ant-design-vue/es/vc-cascader/Cascader").ShowCheckedStrategy>;
        default: string;
    };
