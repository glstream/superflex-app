...
import SkeletonButton from 'ant-design-vue/es/skeleton/Button';
import SkeletonInput from 'ant-design-vue/es/skeleton/Input';
import SkeletonImage from 'ant-design-vue/es/skeleton/Image';
import SkeletonAvatar from 'ant-design-vue/es/skeleton/Avatar';
import SkeletonTitle from 'ant-design-vue/es/skeleton/Title';
export type { SkeletonButtonProps } from 'ant-design-vue/es/skeleton/Button';
export type { SkeletonInputProps } from 'ant-design-vue/es/skeleton/Input';
export type { SkeletonImageProps } from 'ant-design-vue/es/skeleton/Image';
export type { SkeletonAvatarProps } from 'ant-design-vue/es/skeleton/Avatar';
export type { SkeletonTitleProps } from 'ant-design-vue/es/skeleton/Title';
export type { SkeletonProps } from 'ant-design-vue/es/skeleton/Skeleton';
export { skeletonProps } from 'ant-design-vue/es/skeleton/Skeleton';
