import type { AvatarSize } from 'ant-design-vue/es/avatar/Avatar';
...
declare const Group: import("vue").DefineComponent<{
    ...
    size: number | "small" | "default" | "large" | Partial<Record<import("ant-design-vue/es/_util/responsiveObserve").Breakpoint, number>>;
    shape: "circle" | "square";
