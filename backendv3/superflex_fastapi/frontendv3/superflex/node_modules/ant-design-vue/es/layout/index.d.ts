...
export type { BasicProps as LayoutProps } from 'ant-design-vue/es/layout/layout';
export type { SiderProps } from 'ant-design-vue/es/layout/Sider';
...
export declare const LayoutSider: import("vue").DefineComponent<{
    ...
    onCollapse: import("vue").PropType<(collapsed: boolean, type: import("ant-design-vue/es/layout/Sider").CollapseType) => void>;
