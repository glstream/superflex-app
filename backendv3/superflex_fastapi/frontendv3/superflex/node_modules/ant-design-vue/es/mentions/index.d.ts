...
export declare const mentionsProps: () => {
    ...
    filterOption: {
        type: PropType<false | typeof import("ant-design-vue/es/vc-mentions/src/util").filterOption>;
    };
    ...
    options: {
        type: PropType<import("ant-design-vue/es/vc-mentions/src/Option").OptionProps[]>;
        default: import("ant-design-vue/es/vc-mentions/src/Option").OptionProps[];
    };
    rows: (StringConstructor | NumberConstructor)[];
    direction: {
        type: PropType<import("ant-design-vue/es/vc-mentions/src/mentionsProps").Direction>;
    };
};
...
export declare const MentionsOption: import("vue").DefineComponent<{
    label: {
        default: import("ant-design-vue/es/_util/type").VueNode | ((o: import("ant-design-vue/es/vc-mentions/src/Option").BaseOptionsProps) => import("ant-design-vue/es/_util/type").VueNode);
        type: PropType<import("ant-design-vue/es/_util/type").VueNode | ((o: import("ant-design-vue/es/vc-mentions/src/Option").BaseOptionsProps) => import("ant-design-vue/es/_util/type").VueNode)>;
    };
    value: StringConstructor;
    ...
    label: import("ant-design-vue/es/_util/type").VueNode | ((o: import("ant-design-vue/es/vc-mentions/src/Option").BaseOptionsProps) => import("ant-design-vue/es/_util/type").VueNode);
    disabled: boolean;
...
declare const _default: {
    new (...args: any[]): import("vue").CreateComponentPublicInstance<Readonly<ExtractPropTypes<{
        ...
        disabled: boolean;
        autofocus: boolean;
        options: import("ant-design-vue/es/vc-mentions/src/Option").OptionProps[];
        loading: boolean;
